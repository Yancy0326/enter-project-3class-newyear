    ...
    <div className="relative min-h-screen w-full bg-gradient-to-br from-background via-muted/20 to-background overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-12 md:py-20 min-h-screen flex flex-col items-center justify-center">
        ...
        >
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent drop-shadow-2xl">
              马年新春 2026
            </h1>
          </motion.div>
          ...
          {/* 马年装饰 */}
          <motion.div
            className="text-6xl md:text-7xl mt-8"
            animate={{
              y: [0, -10, 0],
            }}
            transition={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl px-4">
          {options.map((option, index) => (
            ...
            >
              <div className="absolute -inset-1 bg-gradient-to-r opacity-0 group-hover:opacity-100 rounded-3xl blur transition-all duration-300"
                style={{
        ...
        >
          ...
          <p className="text-xs">祝您马年大吉，万事如意！</p>
        </motion.div>
      </div>
    </div>
  );
